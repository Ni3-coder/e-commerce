                ...
                <div className="row">
                    ...
                    <div className="col-md-9">
                        ...
                        <div className="m-1 w-75">
                            ...
                            <div className="mb-3">
                                {photo && (
                                    <div className="text-center">
                                        <image src={URL.createObjectURL(photo)} alt="product-photo" height={"200px"} className="img img-responsive" />
                                    </div>
                                )}
                            </div>
                            <div className="mb-3">
                            ...
                            <div className="mb-3">
                                <input type="text" value={description} placeholder="write a description" className="form-control"
